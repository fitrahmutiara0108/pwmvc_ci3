    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Wonder what to eats? <br>Don't worry, our city has a lots to eat</br></h2>
          <ol>
    ...
    <section id="portfolio-details" class="portfolio-details">
      <div class="container">
        ...
        <div>
		  ...
		  <div class="module">
                    <img src="<?php echo base_url('/assets/webprofile/');?>assets/img/food/tahucampur.jpg" alt=""><h7>Tahu Campur</h7>
		  </div>
                </div>

             	<div class="swiper-slide">
		  <div class="module">
                    <img src="<?php echo base_url('/assets/webprofile/');?>assets/img/food/rujakcingur.jpg" alt=""><h7>Rujak Cingur</h7>
		  </div>
                </div>

             	<div class="swiper-slide">
		  <div class="module">
                    <img src="<?php echo base_url('/assets/webprofile/');?>assets/img/food/rawon.jpg" alt=""><h7>Rawon</h7>
		  </div>
                </div>

             	<div class="swiper-slide">
		  <div class="module">
                    <img src="<?php echo base_url('/assets/webprofile/');?>assets/img/food/satekerang.jpg" alt=""><h7>Sate Kerang</h7>
		  </div>
                </div>

             	<div class="swiper-slide">
		  <div class="module">
                    <img src="<?php echo base_url('/assets/webprofile/');?>assets/img/food/semanggisby.jpg" alt=""><h7>Semanggi Surabaya</h7>
		  </div>
                </div>
		...
		<br>When served, the broth is usually garnished with fried garlic, fried shallots, and krupuk bawang garlic crackers. This dish is often prepared and sold by street cart vendors in East Java.</br>
              </p>

              <h3>2.Rujak Cingur</h3>
              <p>
		...
		<br>Traditionally, beef or buffalo muzzle is used in rujak cingur, while fruits and vegetables are served boiled or raw. The dish is assembled and covered with generous amounts of spicy Indonesian dressing made with shrimp paste, peanuts, sugar, and chili. </br>
              </p>
          ...
          <div>
            <div class="portfolio-info">
              <h3>Read More</h3>
              <ul>
                <li><a href="https://www.tasteatlas.com/local-food-in-surabaya">For more information, kindly check on Tasteatlas Website</a></li>
              </ul>
            </div>
          </div>
        </div>
